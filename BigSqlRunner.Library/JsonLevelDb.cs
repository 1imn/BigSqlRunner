...
{
    public class JsonLevelDb<TKey, TValue> : LevelDbWrapper<TKey, TValue>
    {
        ...
        public JsonLevelDb(string levelDbPath)
            : base(levelDbPath, new Options { CreateIfMissing = true }, KeyValueEncoder, KeyValueDecoder<TKey>, KeyValueEncoder, KeyValueDecoder<TValue>)
        {
